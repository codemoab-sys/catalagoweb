-- =====================================================
-- CATÁLOGO DROFAR S.A.C. - INSERCIÓN MASIVA DE DATOS
-- Con codificación UTF-8 (acentos correctos)
-- =====================================================
USE micatalogo;
SET NAMES utf8mb4;
...
-- =====================================================
-- FAMILIA 1: Antisépticos, Desinfectantes y Accesorios
-- =====================================================
...
-- =====================================================
-- FAMILIA 4: Enteral e Irrigación
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 6: Infusión y Acceso Venoso
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 7: Inyección y Punción (Agujas y Accesorios)
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 9: Material de Curación
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
INSERT INTO produtos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 11: Medicamentos - Anestésicos y Bloqueo
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 12: Medicamentos - Antibióticos
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 13: Nutrición Parenteral
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 17: Ropa Médica y Barreras Quirúrgicas
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 18: Soluciones y Sueros
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
-- =====================================================
-- FAMILIA 19: Solventes / Diluyentes (parenteral)
-- =====================================================
INSERT INTO productos (familia_id, marca_id, codigo, nombre_comercial, nombre_producto, composicion, materiales, descripcion, presentacion, laboratorio, estado) VALUES
...
INSERT IGNORE INTO usuarios (usuario, password, nombre, email, rol, estado) VALUES
('admin', MD5('admin123'), 'Administrador', 'admin@drofar.com', 'admin', 1);
